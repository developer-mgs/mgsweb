...
<html>
  <head>
    ...
    <title>MGS CCTV - grosir cctv</title>
...
.search-text{top:40%;width:50%;right:0;margin:20px auto 0;background:0 0;border:none;border-bottom:1px dashed #ddd;font-size:50px;color:#fff;outline:0;position:fixed}
    ...
    <div id="all">
        ...
        <div class="container">
          <div class="row d-flex align-items-center">
            <div class="col-md-6 d-md-block d-none">
              <p>Telp +628 777 555 333 Email mgs@gmail.com.</p>
            </div>
            <div class="col-md-6">
      ...
      <header class="nav-holder make-sticky">
        <div id="navbar" role="navigation" class="navbar navbar-expand-lg">
          <div class="container"><a href="index.html" class="navbar-brand home"><img src="img/logo/logo.png" alt="Universal logo" class="d-none d-md-inline-block"><img src="img/logo-small.png" alt="Universal logo" class="d-inline-block d-md-none"><span class="sr-only">Universal - go to homepage</span></a>
            <button type="button" data-toggle="collapse" data-target="#navigation" class="navbar-toggler btn-template-outlined"><span class="sr-only">Toggle navigation</span><i class="fa fa-align-justify"></i></button>
            <div id="navigation" class="navbar-collapse collapse">
              <ul class="nav navbar-nav ml-auto">
                <li class="nav-item <?php if($basemenu=='home'){ echo 'active';} ?>"><a href="index.php"  class="nav-link">Home <b class="caret"></b></a>
                </li>
                <li class="nav-item <?php if($basemenu=='produk'){ echo 'active';} ?>"><a href="produk.php"  class="nav-link">Produk <b class="caret"></b></a>
                </li>
                <li class="nav-item <?php if($basemenu=='support'){ echo 'active';} ?>"><a href="support.php"  class="nav-link">Support <b class="caret"></b></a>
                </li>
            ...
            <div id="search" class=" clearfix">
              <form role="search" class="navbar-form">
                <div class="input-group">
                    <button type="button" onclick="document.getElementById(&#39;popup_searchBox&#39;).style.display = &#39;block&#39;;" class="btn btn-template-main"><i class="fa fa-search"></i></button></span>
                </div>
              </form>
            </div>
